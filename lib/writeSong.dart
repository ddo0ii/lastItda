...
class _WriteSongState extends State<WriteSong> {
  ...
  void songSetTapping() async{
    await Firestore.instance.collection('songList').document(widget.songKey)
      ...
      'ssubject':ssubject, 'scontent':scontent, 'srecord': _songURL, 'sindexing':sindexing,
...
//        io.Directory appDocDirectory = await getApplicationDocumentsDirectory();
  ...
  _stop() async {
    ...
    StorageReference storageReference = _firebaseStorage.ref().child("songRcd/${_songfireUser.uid}1_$nowtime");
    StorageUploadTask storageUploadTask = storageReference.putFile(file);
    await storageUploadTask.onComplete;
    String downloadURL = await storageReference.getDownloadURL();
    setState(() {
      _songURL = downloadURL;
    });
  }
  ...
  void onPlayAudio() async {
    ...
    await audioPlayer.play(_songURL, isLocal: true);
  }
}